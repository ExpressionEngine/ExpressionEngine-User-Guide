...
- **Enable entry cloning?** -- ([ExpressionEngine Pro](/pro/overview.md) feature) When enabled, entries can be duplicated using "Save as New Entry" option in saving options dropdown.
