...
- **Enable entry cloning?** -- ([ExpressionEngine Pro](/pro/overview.md) feature) When enabled, entries can be duplicated using "Clone to New Entry" option in saving options dropdown.
