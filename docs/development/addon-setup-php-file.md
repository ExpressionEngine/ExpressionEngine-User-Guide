...
It is also possible to set up class aliases to arbitrary FQCN. The example below will set up `AnotherVendor\Services\ClassName` as class alias for `AnotherVendor\Services\ClassName`.
