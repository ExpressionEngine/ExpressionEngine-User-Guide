...
It is also possible to pass multiple roles by separating those with a `|`. In this case, the content will be shown if the member belongs to at least one of the roles.
