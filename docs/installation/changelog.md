...
- Resolved an issue where relationship fields didn't update in LivePreview
- Resolved [#3654](https://github.com/ExpressionEngine/ExpressionEngine/issues/3654) where incorrect fieldtype options were shown on load
...
- Resolved [#4068](https://github.com/ExpressionEngine/ExpressionEngine/issues/4068) where Branding upload disappears
- Fix field_required warning in CP for Pro Variables/Grid with null
- Resolved [#3645](https://github.com/ExpressionEngine/ExpressionEngine/issues/3645) where Autosave does not include data from Grids with Relationships
...
- Resolved [#3975](https://github.com/ExpressionEngine/ExpressionEngine/issues/3975) where Member module could show deprecation notices when using PHP 8.2
- Resolved [#2814](https://github.com/ExpressionEngine/ExpressionEngine/issues/2814) where Date picker shows undefined NaN when user manually enters date into a date field
...
- Made ExpressionEngine 6 compatible with PHP 8.2
...
- Improved Control Panel acessibility for using screen readers
...
- Resolved [#3637](https://github.com/ExpressionEngine/ExpressionEngine/issues/3637) where using File field limited to upload directory on other site would result in JavaScript error
...
- Resolved [#3689](https://github.com/ExpressionEngine/ExpressionEngine/issues/3689) where PHP error could be shown when accessing custom fields
...
- Resolved [#3135](https://github.com/ExpressionEngine/ExpressionEngine/issues/3135), [#3047](https://github.com/ExpressionEngine/ExpressionEngine/issues/3047) where the columns in Entry Manager did not dynamically update if some column is not available
...
- Fixed [#1099](https://github.com/ExpressionEngine/ExpressionEngine/issues/1099) where File Menu width could be too narrow
