...
- Member Groups have been replaced with member roles.
  - Members have one primary role, and can also can have multiple other roles
...
- New Control Panel Design
  ...
  - Added Jump Menu for fast navigation of ExpressionEngine
  ...
  - Add-ons and categories have been moved out of the developer menu and into the sidebar
  - The files page has a new thumbnail view
  - Editing and preview files is now easier in the File Manager
