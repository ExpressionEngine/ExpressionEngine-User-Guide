...
<div id="welcome-grid" class="grid grid-cols-1 lg:grid-cols-3 gap-x-6 gap-y-6 lg:gap-y-0 my-8">
    <a href="https://u.expressionengine.com" class="university rounded-lg bg-purple-new mb-0 text-white text-center overflow-hidden px-7 py-9 flex items-center justify-start flex-col relative border-none">
    ...
    <a href="https://expressionengine.com/partners" class="partners rounded-lg bg-purple-lightest mb-0 text-center overflow-hidden pt-5 pb-7 px-7 flex items-center justify-center flex-col relative border-none">
    ...
    <a href="https://expressionengine.com/support" class="support rounded-lg flex items-center justify-center flex-col bg-purple-regular text-white mb-0 relative h-56 lg:h-auto pt-5 pb-7 px-7 border-none">
...
<div id="welcome-links" class="grid grid-cols-1 lg:grid-cols-2 gap-x-7 gap-y-7 lg:gap-y-0 mb-12">
    <div class="slack rounded-lg bg-purple-regular pl-5 pr-6 py-3.5 relative flex mb-0 items-center">
        ...
        <a href="https://expressionengine.com/blog/join-us-in-slack" class="absolute w-full h-full inset-0 border-none"></a>
    </div>
