...
Date fields render as regular date variables on the front-end. The template parser gives great flexibility when displaying date variables. Visit [Date Variable Formatting](templates/date-variable-formatting.md) to see all that is possible.
