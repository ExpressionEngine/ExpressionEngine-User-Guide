...
.. deprecated:: 2.8.0
  The Cookie Consent module is no longer available for download. The `EU Cookie Laws <http://ec.europa.eu/ipg/basics/legal/cookies/index_en.htm>`_ have changed since we created this module and it's no longer legally required.
