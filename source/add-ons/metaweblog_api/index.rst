...
**Control Panel Location:** :menuselection:`Add-On Manager --> Metaweblog API`
...
:menuselection:`Add-On Manager --> Metaweblog API` in the Control Panel.
...
on the Metaweblog API Control Panel page at :menuselection:`Add-On Manager --> Metaweblog API` to connect with your program. Below is
...
#. For *API Endpoint URL*, enter the URL of your desired configuration
   as shown on the Metaweblog API Control Panel page at :menuselection:`Add-On Manager --> Metaweblog API`.
