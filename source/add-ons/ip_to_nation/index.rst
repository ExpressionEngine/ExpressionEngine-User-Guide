...
**Control Panel Location:** :menuselection:`Developer --> Add-On Manager --> IP to Nation`
...
latest version of ExpressionEngine, and visit the :menuselection:`Developer --> Add-On Manager --> IP to Nation` page in your Control Panel and click the Update IP Database button. The update
...
country, go to :menuselection:`Developer --> Add-On Manager --> IP to Nation` in your Control
