...
The :doc:`Channel tab <tab-channel>` has fields for basic information about the channel, including its name, shortname, and the number of entries allowed in the channel.
