...
.. function:: form_open_multipart([$action = ''[, $attributes = array()[, $hidden = array()]])
	...
	This function is absolutely identical to :func:`form_open()` above, except that it adds a *multipart* attribute, which is necessary if you would like to use the form to upload files with.
...
.. function:: form_password([$data = ''[, $value = ''[, $extra = '']]])
	...
	This function is identical in all respects to the :func:`form_input()` function above except that it uses the "password" input type.
...
.. function:: form_upload([$data = ''[, $value = ''[, $extra = '']]])
	...
	This function is identical in all respects to the :func:`form_input()` function above except that it uses the "file" input type, allowing it to be used to upload files.
...
.. function:: form_textarea([$data = ''[, $value = ''[, $extra = '']]])
	...
	This function is identical in all respects to the :func:`form_input()` function above except that it generates a "textarea" type.
...
.. function:: form_multiselect([$name = ''[, $options = array()[, $selected = array()[, $extra = '']]]])
	...
	The parameter usage is identical to using :func:`form_dropdown()` above, except of course that the name of the field will need to use POST array syntax, e.g. ``foo[]``.
...
.. function:: form_radio([$data = ''[, $value = ''[, $checked = FALSE[, $extra = '']]]])
	...
	This function is identical in all respects to the :func:`form_checkbox()` function above except that it uses the "radio" input type.
...
.. function:: form_reset([$data = ''[, $value = ''[, $extra = '']]])
	...
	Lets you generate a standard reset button. Use is identical to :func:`form_submit()`.
...
.. function:: set_radio([$field = ''[, $value = ''[, $default = FALSE]]])
	...
	Permits you to display radio buttons in the state they were submitted. This function is identical to the :func:`set_checkbox()` function above.
...
.. function:: form_error([$field = ''[, $prefix = ''[, $suffix = '']]])
	...
	Returns a validation error message from the :doc:`../libraries/form_validation`, associated with the specified field name. You can optionally specify opening and closing tag(s) to put around the error message.
...
.. function:: validation_errors([$prefix = ''[, $suffix = '']])
	...
	Similarly to the :func:`form_error()` function, returns all validation error messages produced by the :doc:`../libraries/form_validation`, with optional opening and closing tags around each of the messages.
...
.. function:: form_yes_no_toggle($name, $value)
  ...
  :param string/bool $value: Checked state as ``y``/``n`` or ``TRUE``/``FALSE``
  :returns: Form inputs as HTML
  :rtype: String
...
.. function:: form_preference($name, $details)
  ...
  :param mixed[] $details: The details related to the field (e.g. ``array('type' => 'r', 'value' => 'us', 'subtext' => '', 'selected' => 'us')``)
  :returns: Form input as HTML
  :rtype: String
