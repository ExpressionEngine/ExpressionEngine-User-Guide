...
If you have not installed ExpressionEngine yet, `please do so now </installation/installation>`_,
...
powerful feature with full hiearchy support and more. See the :doc:`Categories </cp/admin/content_admin/category_management>`
...
workflows. See the :doc:`Statuses </cp/admin/content_admin/statuses>` section for more information.
