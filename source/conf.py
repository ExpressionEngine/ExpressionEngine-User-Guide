...
# -*- coding: utf-8 -*-
#
# ExpressionEngine documentation build configuration file, created by
# sphinx-quickstart on Fri Jun 24 07:52:26 2011.
#
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.todo', 'sphinx.ext.ifconfig', 'sphinxcontrib.phpdomain', 'sphinx.ext.extlinks', 'pygments_markdown_lexer']
...
exclude_patterns = ['**/_header.rst', '**/_field_form_fields.rst', '**/_email_module_return_parameter.rst']
...
extlinks = {
    ...
    'expressionengine': ('https://expressionengine.com%s', 'expressionengine'),
    'forum_thread': ('https://expressionengine.com/forums/viewthread/%s/', 'forum_thread'),
...
htmlhelp_basename = 'ExpressionEnginedoc'
